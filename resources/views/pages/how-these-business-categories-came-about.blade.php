...
@section('content')
    <div class="container padding-y">
        <h1 class="text-center text-blue pb-5">How these Business Categories (Industry Sectors) came about</h1>
        ...
        <p class="font-weight-normal text-justify mt-5" style="line-height: 30px;">
        ...
        <p class="text-right font-weight-bold mt-5">Canadian Exports Team</p>
    </div>
