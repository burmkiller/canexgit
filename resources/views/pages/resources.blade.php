...
@section('content')
    ...
    <div class="container padding-y">
        <h1 class="text-center text-blue mb-5">Resources</h1>
        <p class="font-weight-bold" style="line-height: 30px;">
            hese resources might come in handy when doing business with Canada.<br>
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <table class="table">
                    ...
                    <tr>
                        <th scope="row">1</th>
                        <td><a href="http://canada.gc.ca/">Canada Government Web Site</a></td>
                    </tr>
                    <tr>
                        <th scope="row">2</th>
