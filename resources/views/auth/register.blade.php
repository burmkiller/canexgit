...
<div class="container padding-y">
    ...
    <p class="font-weight-bold" style="line-height: 30px;">
        Please fill in this secure online form.<br>
        All online orders are processed the next business day· Pricing includes all applicable taxes·<br>
        Phone order hours: 1-877-333-3014, Mon - Fri, 9am - 5pm EST
    </p>
</div>
...
{{--        ******************************************** 1 *********************************************************--}}
        <h1 class="text-blue mb-5">1 of 4 - Registration Package</h1>
...
{{--        *********************************************** 2 ********************************************************--}}
        <h1 class="text-blue my-5">2 of 4 - User Profile</h1>
...
{{--        *************************************************** 3 *************************************************--}}
        ...
        <h1 class="text-blue my-5">3 of 4 - Select Your Business Categories (Industry Sectors)</h1>
...
{{--            ************************************************* 4 ********************************************--}}
        <h1 class="text-blue my-5">4 of 4 - Business Profile</h1>
        ...
        <h1 class="text-blue my-5" data-toggle="collapse" href="#media" role="button" aria-expanded="false" aria-controls="media">
            Media (optional)
        </h1>
        ...
        <h1 class="text-blue my-5" data-toggle="collapse" href="#social-media" role="button" aria-expanded="false" aria-controls="social-media">
