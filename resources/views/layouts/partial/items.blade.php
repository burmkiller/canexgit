<div id="itb" class="container padding-y">
    ...
    <h1 class="text-blue text-center">{{trans("nav_bar.itb")}}</h1>
    <div class="row d-flex justify-content-between my-5">
        @foreach(getAllItems(3) as $item)
            <div class="col-lg-4 p-3">
            <div class="itb container-fluid">
                <div class="row">
                    <div class="col-lg-12 p-0 img-itb" style="border-bottom: 3px solid #0094D4">
    ...
    <div class="row d-flex justify-content-center">
        <a href="{{url("page/inquiries-to-bay")}}" class="btn btn-outline-blue px-5">ACCESS ALL INQUIRIES</a>
    </div>

    <hr width="60%" class="my-5">
