...
@section("title","Banners and Sponsors Management")
...
@section("content")
    ...
    <div class="block-header">
        <h2>
            <a href="{{route("admin.banners_and_sponsors.create")}}" class="btn btn-primary waves-effect">
                <i class="material-icons">add</i>
                <span>Create New Banners or Sponsors</span>
            </a>
        </h2>
    </div>
                        ...
                        <table class="table table-bordered table-striped table-hover dataTable js-exportable ">
                            ...
                            @foreach($allBS as $key=>$bs)
                                <tr>
                                    ...
                                    <td>
                                        <img src="{{asset("storage/".$bs->image)}}" class="img-thumbnail" width="100 vh" height="100 vh" alt="Responsive image">
                                    </td>
                                    <td>{{$bs->created_at}}</td>
                                    <td class="text-center">
                                        <a href="{{route("admin.banners_and_sponsors.edit",$bs->id)}}" class="btn btn-info waves-effect">
                                        ...
                                        <form action="{{route("admin.banners_and_sponsors.destroy",$bs->id)}} "
