    ...
    <div class="container padding-y">
        ...
        <div class="row d-flex align-items-center mb-5">
            <div class="col-lg-3 d-flex justify-content-center">
                <img src="{{isset($profile->media()->get()->first()->logo)?asset("storage/".$profile->media()->get()->first()->logo):asset("assets/front_end/images/default.jpeg")}}" class="img-fluid">
            </div>
            <div class="col-lg-9 sp-15">
                <h4 class="text-blue font">{{$profile->company_name}}</h4>
                <p>
